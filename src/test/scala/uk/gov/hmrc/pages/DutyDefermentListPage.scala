...
object DutyDefermentListPage extends WebPage with LazyLogging with ScalaFutures {
  ...
  def getFileName: String = {
    waitForElement(By.xpath("//*[@id='content']/div/div/ul/li[1]/a"))
    find(xpath("//*[@id='content']/div/div/ul/li[1]/a")).get.underlying.getText
  }
  ...
  //    val sizeInWords: String = webdriver.findElement(By.cssSelector(s".duty-deferment-statements li:nth-child(${i}) .file-size")).getText.trim
